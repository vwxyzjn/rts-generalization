...
python generate_exp.py --exp-script scripts/ppo_autoregressive2.sh \
    ...
    --gym-ids MicrortsDefeatRandomEnemyShapedReward-v2 MicrortsDefeatWorkerRushEnemyShaped-v2 MicrortsDefeatLightRushEnemyShaped-v2 MicrortsDefeatWorkerRushEnemyHRL-v2 MicrortsDefeatCoacAIShaped-v2 \
    --wandb-project-name gym-microrts \
    --other-args "--wandb-entity vwxyzjn --cuda False"
